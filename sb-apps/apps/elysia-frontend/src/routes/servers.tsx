...
import { PageHeader, Card, CardContent, StatusDot } from "../components/ui";
import { Play, Square, Trash2, RefreshCw, Plus, Server } from "lucide-react";
        ...
        actions={
          <>
            <button
              ...
              className="p-2 rounded-md border border-[var(--border)] hover:bg-[var(--surface-elevated)] transition-colors"
              title="Refresh"
            >
              <RefreshCw size={18} />
            </button>
            <button className="flex items-center gap-2 px-4 py-2 rounded-md bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white text-sm font-medium transition-colors">
              <Plus size={16} />
              New Server
            </button>
          </>
        ...
        <div className="border border-[var(--border)] rounded-lg overflow-hidden">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[var(--border)]">
              {servers.map((server) => (
                <tr key={server.id} className="hover:bg-[var(--surface-elevated)] transition-colors">
