...
const startServerDef = toolDefinition({
  name: "start_server",
  description:
    "Start a game server by name. Use this when the user wants to start a server.",
  inputSchema: z.object({
...
const stopServerDef = toolDefinition({
  name: "stop_server",
  description:
    "Stop a game server by name. Use this when the user wants to stop a server.",
  inputSchema: z.object({
...
const getSystemStatsDef = toolDefinition({
  ...
  description:
    "Get current system statistics including CPU, memory, GPU, network, and disk I/O",
  inputSchema: z.object({}),
});
...
const getDrivesDef = toolDefinition({
  name: "get_drives",
  description:
    "Get information about registered storage drives and their usage",
  inputSchema: z.object({}),
});
    ...
    try {
      ...
      const messagesWithSystem = [
        ...
        },
        {
          ...
          content:
            "I understand. I'm The Machine, ready to help manage your Superbloom homelab.",
        },
        ...messages,
      ];
